...
const (
	...
	AuthService_Login_FullMethodName                     = "/etu.AuthService/Login"
...
type AuthServiceClient interface {
	...
	// Login validates credentials and issues a revocable user API key for a native client.
	// The raw key is returned only once; use VerifyApiKey/GetUser to restore user context.
	Login(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*CreateApiKeyResponse, error)
...
func (c *authServiceClient) Login(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*CreateApiKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	// Login validates credentials and issues a revocable user API key for a native client.
	// The raw key is returned only once; use VerifyApiKey/GetUser to restore user context.
	Login(context.Context, *AuthenticateRequest) (*CreateApiKeyResponse, error)
	// GetUser fetches a user by id.
...
func (UnimplementedAuthServiceServer) Login(context.Context, *AuthenticateRequest) (*CreateApiKeyResponse, error) {
...
const (
	...
	UserSettingsService_GetProfileImageURL_FullMethodName = "/etu.UserSettingsService/GetProfileImageURL"
)
...
type UserSettingsServiceClient interface {
	...
	// GetProfileImageURL resolves a profile image key to a short-lived URL.
	GetProfileImageURL(ctx context.Context, in *GetProfileImageURLRequest, opts ...grpc.CallOption) (*GetProfileImageURLResponse, error)
}
...
func (c *userSettingsServiceClient) GetProfileImageURL(ctx context.Context, in *GetProfileImageURLRequest, opts ...grpc.CallOption) (*GetProfileImageURLResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProfileImageURLResponse)
	err := c.cc.Invoke(ctx, UserSettingsService_GetProfileImageURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserSettingsServiceServer interface {
	...
	// GetProfileImageURL resolves a profile image key to a short-lived URL.
	GetProfileImageURL(context.Context, *GetProfileImageURLRequest) (*GetProfileImageURLResponse, error)
...
func (UnimplementedUserSettingsServiceServer) GetProfileImageURL(context.Context, *GetProfileImageURLRequest) (*GetProfileImageURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProfileImageURL not implemented")
}
...
func _UserSettingsService_GetProfileImageURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProfileImageURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserSettingsServiceServer).GetProfileImageURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserSettingsService_GetProfileImageURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserSettingsServiceServer).GetProfileImageURL(ctx, req.(*GetProfileImageURLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserSettingsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserSettingsService_GetProfileImageURL_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/etu.proto",
